import { system, world, CommandPermissionLevel, CustomCommandParamType, CustomCommandStatus, GameMode, PlayerPermissionLevel } from "@minecraft/server";
import { ActionFormData, CustomForm, MessageFormData, ModalFormData, ObservableBoolean, ObservableString } from "@minecraft/server-ui";
///$F
function $FblockTpChecker($subject, $target, $fromx, $fromy, $fromz, $fromDim) {
        ...
        if ($player.playerPermissionLevel === PlayerPermissionLevel.Operator) {
            system.run(() => {
                ...
                $netherMainToggle.subscribe(() => {
                    ...
                    if ($netherMainToggle.getData() === false) {
                        $netherTpToggle.setData(false);
                ...
                $endMainToggle.subscribe(() => {
                    ...
                    if ($endMainToggle.getData() === false) {
                        $endTpToggle.setData(false);
                ...
                $statusForm.divider();
                $statusForm.label("Nether: " + world.getDynamicProperty("dd:isNetherEnabled") + "\n"
                    + "Teleport: " + world.getDynamicProperty("dd:netherTpToggle") + "\n"
                    + "Teleport timer: " + world.getDynamicProperty("dd:netherTimer") + " seconds." + "\n"
                    + "Message: " + world.getDynamicProperty("dd:netherMsg") + "\n"
                    + "Message timer: " + world.getDynamicProperty("dd:netherMsgTimer") + " seconds.");
                $statusForm.divider();
                $statusForm.label("End: " + world.getDynamicProperty("dd:isEndEnabled") + "\n"
                    + "Teleport: " + world.getDynamicProperty("dd:endTpToggle") + "\n"
                    + "Teleport timer: " + world.getDynamicProperty("dd:endTimer") + " seconds." + "\n"
                    + "Message: " + world.getDynamicProperty("dd:endMsg") + "\n"
                    + "Message timer: " + world.getDynamicProperty("dd:endMsgTimer") + " seconds.");
                $statusForm.spacer();
                $statusForm.divider();
                $statusForm.label("Addon made by: Redmond Limited Co.");
                /// MAIN FORM
